...
1. Copie o template abaixo para `docs/specs/AAAA-MM-DD-nome-curto.md`.
2. Preencha as seções — pode ser em texto corrido, não precisa ser perfeito.
3. Cole a spec no chat do Cursor e peça: *"leia essa spec e o
   docs/ARCHITECTURE.md, depois me diga quais arquivos você pretende tocar
   ANTES de editar qualquer coisa"*. Revise a lista antes de deixar ele
   codar.
...
- Specs guardadas em `docs/specs/` viram, com o tempo, a documentação de
